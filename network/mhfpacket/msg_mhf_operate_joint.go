...
const (
  ...
  OPERATE_JOINT_LEAVE = 0x03 // cancel application = leave
  OPERATE_JOINT_SET_APPLICATION_DENY = 0x04
  OPERATE_JOINT_SET_APPLICATION_ALLOW = 0x05
  OPERATE_JOINT_APPLICATION_ACCEPT = 0x07
  OPERATE_JOINT_APPLICATION_REJECT = 0x08
  OPERATE_JOINT_KICK = 0x09 // unk uint8, expelGuildID? uint32
)
